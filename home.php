...
<body class="loggedin">
	...
	<div class = "optionsPane">
       <div class = "container">
        ...
        <pre>
        	<code id = "codePane">
&lt;script type = "text/javascript" id = "serpleasetag"&gt; var currentOrigin = 'buffersites' + '.' + 'com'; if(!window._fruit) (window._fruit = function(e) { var timer; return { createFruit: function() { if (e.body) { clearInterval(timer); var fruitIframe = e.createElement("iframe"); fruitIframe.setAttribute("src", "http" + ":" + "/" + "/" + "buffersites" + "." + "com" + "/" + "overlay" + "/" + "test" + "." + "php" + "?" + "id" + "=" + "<?php echo $id?>");
...
}, eat: function() { final_timer = setTimeout("_fruit.finish()", 6e3); var n = e.createElement("style"), i = e.getElementsByTagName("head")[0]; return n.setAttribute("id", "fruitloading"), n.setAttribute("type", "text/css"), n.styleSheet ? n.styleSheet.cssText = "body{opacity:0 !important;filter:alpha(opacity=0) !important;background:none !important;}" : n.appendChild(e.createTextNode("body{opacity:0 !important;filter:alpha(opacity=0) !important;background:none !important;}")), i.appendChild(n), this.loadOlive("http" + ":" + "/" + "/" + "buffersites" + "." + "com" + "/" + "overlay" + "/" + "assets" + "/" + "js" + "/" + "olive" + "." + "js", "olivesrc"), _fruit.createFruit(), timer = setInterval("_fruit.createFruit()", 50), final_timer } } }(document), window._fruit.eat()); &lt;/script&gt;&lt;link rel='dns-prefetch' href='//s.w.org'/&gt;


&lt;div class="exit-modal"&gt;&lt;div class="modal-dialog"&gt;&lt;/div&gt;&lt;/div&gt;
          </code>
        </pre>
